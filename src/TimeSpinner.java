...
//Reference: The following piece of code is taken from stackoverflow posted by James_D
public class TimeSpinner extends Spinner<LocalTime> {
    ...
    public TimeSpinner(LocalTime time) {
        ...
        mode.addListener((obs, oldMode, newMode) -> newMode.select(this));  // When the mode changes, select the new portion
    }
